# Pocket Lawyer — AI Personality & Behaviour Specification
**Version:** 1.0  
**Last Updated:** April 2, 2026  
**Purpose:** This document captures every personality trait, behavioural rule, tone guideline, and prompt engineering decision made for the Pocket Lawyer AI engine. This serves as the **master reference** for fine-tuning our own AI model in the future.
